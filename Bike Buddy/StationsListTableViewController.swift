...
class StationsListTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        /*let storyboard: UIStoryboard = UIStoryboard(name: Constants.sharedInstance.storyboardViewIdentifier, bundle: nil)
        let firstTimeUseView = storyboard.instantiateViewControllerWithIdentifier(Constants.sharedInstance.firstTimeUseViewIdentifier) as! UIViewController
        firstTimeUseView.modalPresentationStyle = UIModalPresentationStyle.FormSheet
        
        self.presentViewController(firstTimeUseView, animated: true, completion: nil)*/
